...
function App() {
  return (
    <div className="px-10 sm:px-12 md:px-16 lg:px-36">
      <div className="flex flex-col-reverse md:flex-row justify-center md:justify-between items-center min-h-screen mb-10">
